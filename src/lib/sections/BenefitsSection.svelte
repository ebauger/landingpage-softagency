...
<section class="benefits" bind:this={benefitsSection}>
	<h2>{t.benefits.partnerForSuccess}</h2>
	<h3>{t.benefits.managingTech}</h3>
	<div class="benefit-grid">
		<div class="benefit-item">
			<img
				...
				use:viewport={{ once }}
			/>
			<p class="text-center">{t.benefits.subscribeAndAsk}</p>
		</div>
		<div class="benefit-item">
			<img
				...
				use:viewport={{ once }}
			/>
			<p class="text-center">{t.benefits.receiveChange}</p>
		</div>
		<div class="benefit-item">
			<img
				...
				use:viewport={{ once }}
			/>
			<p class="text-center">{t.benefits.tuneUp}</p>
		</div>
		<div
		...
		>
			...
			<cite class="text-center text-2xl font-semibold">
				{t.benefits.testimonialText}
			</cite>
			<div class="flex flex-row items-center gap-4">
				<Avatar src="/testimonials/riel.jpeg" width="w-12" />
				<p class="inline-block text-base">
					{t.benefits.testimonialName}, <strong>{t.benefits.testimonialCompany}</strong>
				</p>
			</div>
