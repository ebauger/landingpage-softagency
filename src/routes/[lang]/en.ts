export const content = {
	benefits2: {
		...
		coreTeam:
			'We are a branch of your core team. Share your request directly with a CTO with an engineering degree.',
		testimonialText:
			'I am satisfied with his expertise during the transition to our new platform and I recommend him.',
		...
		bringYourStack: {
			...
			description:
				"We enhance your own stack. If you don't have one, we'll provide the right one for your project"
		},
	...
	whyWorkUs: {
		...
		reasons: {
			...
			ctoReplacement: 'We need to replace our CTO',
			hiringHelp: 'Help us to hire an agency or a software engineer and build our internal team',
			ctoLeaveReplacement: 'We need to replace for a parental leave or departure.'
		}
	},
	plans: {
	...
	faqs: {
		...
		questions: [
			...
			},
			{
				...
				content:
					"You could, in but the reality it's difficult to hire a fulltime senior-level software engineer. Actually, to entry salaries exceed $135 000, plus beneficts. The process for hiring one is long and costly. It cost thosands of dollars for just hiring process. \n\nSometimes it's more valuable to spend your time on your business and let us handle the technology."
			},
			{
				summary: 'Really unlimited?',
				content:
					"Once you have your membership, you can submit as many requests on our queue as you want. And we'll be delivery one by one. First in first out."
			},
			{
			...
			},
			{
				...
				content:
					"ZBRANCH is actually a studio of one person. The founder, myself, will work directly with you. For bigger ou more complex request, like custom backend or particular tech expertise with senior level engineer, I'll work with our network of senior level engineer or third parties provider like AWS."
			},
			{
				summary: 'What stack do you use?',
				content:
					'For frontend, we use SvelteKit/Skeleton/Tailwind. For backend, we use Supabase or SurrealDB. For the infrastructure deploying we can deploy on AWS, Vercel, Netlify or Cloudflare or custom deployment with Kubernetes. \n\nIf you already a custom stack like react or vue or any language like PHP, Python, Ruby. We can work with your stack.'
			},
			{
				summary: "What if I don't like the service?",
				content:
					'We provide a high quality of service, there will be no refunds issued. You may cancel your membership on the portal.'
			}
		]
	},
	footer: {
